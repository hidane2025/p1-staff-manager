...
_QUICK_NAV_GROUPS = [
    ...
    ("🔴 当日運用（毎日）", [
        ("🎰 ピット端末", "pages/10_pit_terminal.py"),
        ("🕐 出退勤", "pages/5_attendance.py"),
    ...
    ("🛠 準備・設定", [
        ("📋 イベント設定", "pages/0_event_setup.py"),
        ("👥 スタッフ管理", "pages/1_staff.py"),
        ("📅 シフト取込", "pages/2_shift_import.py"),
        ("🚃 交通費", "pages/8_transport.py"),
